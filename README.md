...
#### Disable auto-hide of children chapters

By default, The Gestalt Theme hide the chapters children of root chapters. Sometimes, when we are using another plugin to expand/collapse chapters, we want to disable this feature. To achieve this, edit your `book.json` file to include the following:
